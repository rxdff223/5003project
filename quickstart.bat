@echo off
REM 快速启动指南（Windows PowerShell/CMD）
...
echo.
echo    创建数据库:
echo    psql -U postgres -c "CREATE DATABASE air_quality_db;"
echo.
echo    运行SQL迁移:
...
echo.
echo 需要帮助? 运行以下命令查看详细文档:
echo    start API_DOCUMENTATION.md
echo    start BACKEND_README.md
echo.
